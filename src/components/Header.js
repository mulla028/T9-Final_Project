            ...
            <Container fluid="md">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="m-auto flex">
                        ...
                        <Nav.Link href="#features" className="no-bold-link">Features</Nav.Link>
                        <Nav.Link href="#eco-partners" className="no-bold-link">Eco Partnerships</Nav.Link> {/* Links to EcoPartners */}
