        ...
        <UserLayout>
            ...
            <Card className={styles["profile-card"]}>
                ...
                <div className={styles["profile-header"]}>
                    {user.profilePicture ? <img src={user.profilePicture} alt="Profile" className={styles["profile-pic"]} /> : <img src="/icon/default-icon.png" alt="default" style={{ width: '60px', height: '60px', objectFit: 'cover' }} />}
